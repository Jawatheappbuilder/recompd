...
import { deleteCustomExercise, loadCustomExercises, updateCustomExercise } from "@/lib/workout-storage";
...
function CustomExercisesPage() {
  const [items, setItems] = useState<Exercise[]>([]); const [editing, setEditing] = useState<Exercise | null>(null); const [removing, setRemoving] = useState<Exercise | null>(null);
  const refresh = () => setItems(loadCustomExercises());
  useEffect(refresh, []);
